 ...
 *
 */
public class XYStackedAreaChart extends StackedXYChart<XYSeries> {
	...
	protected void createChart() {
		...
		chart = ChartFactory.createStackedXYAreaChart( name, yAxisLabel, xAxisLabel, data, PlotOrientation.VERTICAL, true, false, false);
