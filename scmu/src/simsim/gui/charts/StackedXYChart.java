 ...
 *
 */
abstract public class StackedXYChart<T extends Series> implements Displayable {

	private static RGB[] colors = { RGB.RED, RGB.BLUE, RGB.GREEN, RGB.MAGENTA, RGB.CYAN, RGB.ORANGE } ;

	protected String name ;
	protected JFreeChart chart;
	protected DefaultTableXYDataset data ;
	protected StackedXYAreaRenderer2 renderer ;
	protected String xAxisLabel, yAxisLabel ;

	protected Map<String, T> series ;
	
	
	public StackedXYChart( String frame, double fps, String xAxisLabel, String yAxisLabel ) {
		this.name = frame ;
